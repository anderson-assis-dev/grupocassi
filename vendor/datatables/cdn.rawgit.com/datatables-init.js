...
$(document).ready(function() {
    ...
    var d = 'Mapa de Serviço - Impresso em: ' + day + "-" + month + "-" + year + " " + hour + ":" + min + ":" + seg + "\n" ;
    ...
    function getBase64FromImageUrl(url) {
        ...
        img.onload = function () {
            ...
            var dataURL = canvas.toDataURL("../.././images/logo.png");
    ...
    $('#example23').DataTable({
        ...
        "language": {
            ...
            "oAria": {
                "sSortAscending":  ": Selecione esta opção para classificar a coluna em forma de crescente",
                "sSortDescending": ": Selecione esta opção para classificar a coluna em decrescente"
            }
        },
        buttons: [
            'csv', 'excel',

            {
                extend: 'copyHtml5',
                text: 'Copiar',
                messageTop: 'As informações foram copiadas para área de transferência',
                key: {
                    key: 'c',
                    altkey: true
                }
                        ...
                        return {
                            columns: [
                                ...
                                },
                                {
                                    alignment: 'center',
                                    italics: false,
                                    text: 'Total Pax (' + localStorage.getItem("totalpax") + ") Total Ch (" + localStorage.getItem("totalchild") + ")",
                                    fontSize: 15,
                                    margin: [0,0]
                                },
                                {
