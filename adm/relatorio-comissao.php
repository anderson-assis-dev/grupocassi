...
$todos_cliente = $pdo->prepare('select * from `ct_cliente` order by `fullname` ');
$todos_cliente->execute();
?>
<style>
                    ...
                    <div class="au-breadcrumb-content">
                        <div class="au-breadcrumb-left">
                            ...
                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                ...
                                <li class="list-inline-item">Financeiro: Relatório Comissão</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="./relatorio/pdf-relatorio-pagamentos-comissao" target="_blank" method="post">
                            <div class="col-md-6 pull-left">
                                ...
                                <select  required class="form-control" name="responsavel" id="responsavel" >
                                    ...
                                    <?php while( $responsavel = $todosusuario->fetch( PDO::FETCH_ASSOC ) ){ ?>
                                        <option value="<?php echo($responsavel['id']); ?>"><?php echo($responsavel['firstname']." ".$responsavel['lastname']); ?></option>
                                    <?php }?>
                                </select>
                            </div>
                            <div class="col-md-6 pull-right">
                                <strong><label for="responsavel">Cliente</label></strong>
                                <select  required class="form-control" name="cliente" id="cliente" >
                                    <option selected value="0">TODOS</option>
                                    <?php while( $cliente = $todos_cliente->fetch( PDO::FETCH_ASSOC ) ){ ?>
                                        <option value="<?php echo($cliente['id']); ?>"><?php echo(utf8_encode($cliente['fullname'])); ?></option>
                                    <?php }?>
                                </select>
                            </div>
                            <div class="col-md-6 pull-left">
