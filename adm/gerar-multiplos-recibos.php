...
<div class="page-content--bgf7">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <form action="relatorio/imprimir-multiplos-recibos" method="post" target="_blank">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="text" value="<?php echo($item->valordiaria); ?>" class="form-control diaria" name="<?php echo("diaria".$contador); ?>">
                                                                </div>
                                                            </td>
                                            ...
                                            <button class="btn btn-outline-primary pull-right" id="gerar" onclick="bloquear()" type="submit">Gerar recibos </button>
                                            <button class="btn btn-outline-warning pull-right" id="desbloquear" onclick="desbloquear()" type="button"><i id="aberto" class="fas fa-lock-open"></i>
                                                <i style="display: none;" id="fechado" class="fas fa-lock"></i> </button>
                                        </form>
    ...
    <script>
        ...
        function bloquear(){
            $("#gerar").text("Destrave no botão ao lado");
        ...
        function Adicionar(){
            ...
            html += '<td><div class="input-group mb-3"> <div class="input-group-prepend"><span class="input-group-text" id="basic-addon1">R$</span> </div><input type="text" value="50" class="form-control diaria" name="diaria'+contador+'"></div> </td>';
