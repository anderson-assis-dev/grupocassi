...
if( isset($_POST['pax']) )
{
    $reservas = $pdo->prepare(
            'select r.pax, r.numbervoucher, r.qtdpax, r.qtdchild, r.qtdfree, u.firstname, c.fullname, s.fullname as servico, r.dateinput 
                ...
                <div class="col-md-12">
                    <div class="au-breadcrumb-content">
                        <div class="au-breadcrumb-left">
                            <span class="au-breadcrumb-span">Nevagação:</span>
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        ...
                        <?php if( !empty($numberVoucher) and !empty($dadosGerais) and isset($_POST['voucher']) ){ ?>
                            <h4>Dados da Reserva | Voucher de Número: <?php echo($numberVoucher); ?> </h4>
                            <hr>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <?php }?>
                                        <tr>
                                           <td><?php echo htmlentities($dadosGerais['cliente'], ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($dadosGerais['pax'], ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($dadosGerais['documento'], ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($dadosGerais['qtdpax']."/".$dadosGerais['qtdchild'], ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($dadosGerais['servico'], ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities(date("d/m/Y", strtotime($dadosGerais['dateinput'])), ENT_QUOTES, 'UTF-8'); ?></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <?php foreach( $registroAdm as $item5) { ?>
                                                <tr>
    <td><?php echo htmlentities(date('d-m-Y', strtotime($item5->datematurity)), ENT_QUOTES, 'UTF-8'); ?></td>
    <td><?php echo htmlentities(date('d-m-Y', strtotime($item5->datepayment)), ENT_QUOTES, 'UTF-8'); ?></td>
    <td><?php echo htmlentities($item5->numberadd, ENT_QUOTES, 'UTF-8'); ?></td>
    <td><?php echo htmlentities($item5->name, ENT_QUOTES, 'UTF-8'); ?></td>
    <td>
                                                        <form action="" method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <?php foreach ($all_reservas as $item){ ?>
                                        <tr>
                                            <td><?php echo htmlentities($item->numbervoucher, ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($item->pax, ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($item->qtdpax."/".$item->qtdchild."/".$item->qtdfree, ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($item->firstname, ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($item->fullname, ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities($item->servico, ENT_QUOTES, 'UTF-8'); ?></td>
<td><?php echo htmlentities(date("d-m-Y", strtotime($item->dateinput)), ENT_QUOTES, 'UTF-8'); ?></td>
<td>
