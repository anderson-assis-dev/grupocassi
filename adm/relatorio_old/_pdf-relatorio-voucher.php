...
if( isset( $_POST['voucher'] )  )
{
    ...
    $descreverCredito = $pdo->prepare(
        ...
        left join ct_usuario u on u.id = cfc.idusr where `numbervoucher` = :numbervoucher ');
    ...
    <div align="center" class="container">
	    ...
	    <div class="col-md-6 pull-left">
            ...
            <div style="margin-top: -20px;">
                <p class="" style="margin-right: 340px;  position: absolute; font-size: 12px;"><?php echo(utf8_decode('Nº VOUCHER')); ?>:</p>
