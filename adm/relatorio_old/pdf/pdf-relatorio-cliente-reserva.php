...
cp.namepayment as pagamento, qtdpax, qtdchild, nameinvoice as statuu, r.valueservice, r.horaap, r.numberfatura, r.idservico
                ...
                <table class="highlight">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo(" R$ ".number_format($dadosCliente['credito'],2,",","." ))."<br>"; ?></td>
                            <td><?php echo(" R$ ".number_format($dadosCliente['tarifa'] - $dadosCliente['credito'],2,",","." ))."<br>"; ?></td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <?php foreach ($dadosPrincipais as $item){
                            ...
                            $buscarConferenciaAdd = $pdo->prepare(
                                'select  ra.dateinput, ra.dateoutput, numbervoucher, c.namefantazia as cliente ,pax,
                                             ...
                                             ra.valueservice,  r.idcliente as idcliente, ra.horaap from `ct_recentlyadd` ra 
                            ...
                            <?php } else{ ?>
                                <tr>
                                    <td><?php echo( $item->numbervoucher." Faturado para a fatura de número ".$item->numberfatura); ?></td>
                                </tr>
                            <?php }?>
