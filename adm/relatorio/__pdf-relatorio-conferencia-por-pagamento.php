    ...
    <?php  if( $verify > 0 ) { ?>
        ...
        <div class="container">
            ...
            <p><?php echo( utf8_decode(
                    ...
                    date("d/m/Y ", strtotime( $inicio ))." ate ".date("d/m/Y ", strtotime( $fim )))); ?> </p><br>
            ...
            <table class="highlight">
                ...
                <?php foreach ( $data_find_file_salesmen as $item ) {
                    ...
                    ?>
                    <?php if( date("d/m/Y", strtotime($data_find_reservation_primary['dateinput'])) <> '31/12/1969' ){ ?>
                        <tr>
                            ...
                            <td><?php echo(date("d/m/Y", strtotime($data_payment_of_cliente2['dia']))); ?></td>
            ...
            <?php if( $verify_caixa > 0 and !empty($verify_caixa) ){ ?>
                ...
                <table id="" class="highlight" >
                    ...
                    <tbody>
                    <?php foreach( $registroCaixa as $item ){  $total_out += $item->valor?>
                        <tr>
...
<?php } else {
    ...
    <div class="container">
        ...
        <table class="highlight">
            ...
            <tbody>
                <?php $total =0; foreach($reservas as $item){ $total += $item->valuecredit; ?>
                    <tr>
